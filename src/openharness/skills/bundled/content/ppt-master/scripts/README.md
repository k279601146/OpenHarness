...
This directory contains user-facing scripts for conversion, project setup, direct PPTX template filling, SVG processing, export, recorded narration, web image search, and image analysis.
...
| Image tools | `image_search.py`, `latex_render.py`, `analyze_images.py`, `gemini_watermark_remover.py` | [docs/image.md](./docs/image.md) |
...
# Submit this prompt through the SaaS generate_image service: "A modern futuristic workspace"
# Backend listing is managed by the SaaS media model registry.
...
- Prefer the unified entry points `project_manager.py`, `finalize_svg.py`, and SaaS `generate_image`
